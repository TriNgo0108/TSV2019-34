...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:TopBar(title: 'Thông tin khoa', child: Icon(Icons.arrow_back,),onPressed: (){
      ...
      body: Column(
          children: <Widget>[
            Padding(
              ...
              child: Text(
                'Trường Đại học Cần Thơ có 17 Khoa và Viện ',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold ),
              ),
            ),
            Expanded(
              child: PageView(
                ...
                children: <Widget>[
                  for (var i = 0; i<collegeList.length;i++)
                    CollegeWidget(college: collegeList[i], pageController: _pageController, currentPage: i)
                ],
              ),
            ),
          ],
