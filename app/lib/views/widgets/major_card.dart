    ...
    return Container(
      child: Column(
        children: <Widget>[
          ...
          widget.major.specializations[0].videoId.length == 11 ? YoutubePlayer(
            key: new GlobalKey(),
            context: context,
          ...
          ) : Text("Video Id Invalid") : Text("Video not found"),
          ListTile(
            title: Text(
            ...
            subtitle: Text(widget.major.inputRequest[0].combinations.toString()),
            trailing: Container(
              child: Column(
                ...
                children: <Widget>[
                  Container(
                      ...
                      child:
                          Text(widget.major.seasons[0].points.toString(), maxLines: 1),
